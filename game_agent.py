...
def custom_score(game, player):
    ...
    return custom_score_weighted(game, player, 1, 1.5)
...
def custom_score_2(game, player):
    ...
    """
    # TODO: finish this function!
    return custom_score_weighted(game, player, 2, 3)
    # raise NotImplementedError
...
def custom_score_3(game, player):
    ...
    """
    # TODO: finish this function!
    return custom_score_weighted(game, player, 2.5, 2)
    # raise NotImplementedError
...
class MinimaxPlayer(IsolationPlayer):
    ...
    def minimax(self, game, depth):
        ...
        **********************************************************************
        ...
        # TODO: finish this function!
        return self.m_move(game, depth)[0]

    def active_player(self, game):
        return game.active_player == self

    def m_move(self, game, depth):
        if self.time_left() < self.TIMER_THRESHOLD:
            raise SearchTimeout()
        ...
        for move in game.get_legal_moves():
            ...
            score = self.m_move(next_ply, depth - 1)[1]
...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def alphabeta(self, game, depth, alpha=float("-inf"), beta=float("inf")):
        ...
        **********************************************************************
        ...
        return self.albe(game, depth)[0]

    def active_player(self, game):
        return game.active_player == self

    def albe(self, game, depth, alpha=float("-inf"), beta=float("inf")):
        if self.time_left() < self.TIMER_THRESHOLD:
            raise SearchTimeout()
        ...
        for move in game.get_legal_moves():
            next_ply = game.forecast_move(move)
            score = self.albe(next_ply, depth - 1, alpha, beta)[1]
